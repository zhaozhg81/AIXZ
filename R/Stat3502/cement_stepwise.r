...
# check in x4 model, nothing can be deleted
...
# check in x1 x4 model, nothing can be deleted
...
# check in x1x2x4 model, x4 (2.053954e-01) can be deleted

# can we add anything to x1x2 model?

summary(lm(y~x1+x2+x3,data=mydata))$coefficients
