...
text(2,1.2,"y bar vector")

segments(2.2,1,2.5,3,col="purple",lty=2)

segments(2.2,1,2.5,.4,col="purple",lty=2)

######################################

plot(1, axes=FALSE,type="n", xaxt="n", yaxt="n", xlab="", ylab="", xlim=c(-.5,4.5),ylim=c(-1,4))

arrows(.6,.2,2.6,.2,col="purple",lty=2)

arrows(2.6,.2,2.6,3,col="red")

arrows(.6,.2,2.6,3,col="purple",lty=2)

text(3.4,1.7,"residual vector", col="red")

text(1,1.5,"(y - y bar) vector", col="purple")

text(1.4,-.1,"(y hat - y bar) vector", col="purple")